...
//Quiero ser colaborador Xd Jorge mas te vale que funcione esta mierda
          ...
          <div className="flex-1 text-center md:text-left space-y-4">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <textarea id="mensaje" name="mensaje" value={formData.mensaje} rows={5} onChange={handleChange} required
                className="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-800 dark:text-white shadow-sm p-2 resize-none">
                </textarea>
